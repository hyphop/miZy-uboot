...
#define SPI_SCRIPT_BYTES	8192
#define SPI_SCRIPT_OFFSET	589824

#define BOOTENV_DEV_SPI(devtypeu, devtypel, instance) \
	"spi_scr_offset=0080000\0" \
	"spi_scr_size=0008192\0" \
	"bootcmd_spi=if test -n ${force_spi} || itest.b *0x28 == 0x03; " \
	"then spiread.hd ${scriptaddr} ${spi_scr_offset} ${spi_scr_size}; " \
	"source ${scriptaddr}; " \
	"fi\0"
...
#define CONFIG_PREBOOT	"run mizycmd"
